      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full ">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5  shadow-2xl shadow-[#0E0E10]">
          ...
          <div className="flex flex-col gap-5 my-5 text-white">
            ...
            <p className="animatedText text-neutral-400">
              {currentProject.desc}
            </p>
            <p className="animatedText text-neutral-400">
          ...
          <div className="flex items-center  justify-between flex-wrap gap-5">
            <div className="flex items-center gap-3">
              {currentProject.tags.map((tag, index) => (
                <div
                  key={index}
                  className="w-10 h-10 rounded-md p-2 bg-neutral-800 bg-opacity-10 backdrop-filter backdrop-blur-lg flex justify-center items-center">
            ...
            <a
              ...
              className="flex items-center cursor-pointer  gap-2 text-neutral-400"
              tag="_blank"
              rel="noreferrer">
              <p>check live site</p>
              <img
