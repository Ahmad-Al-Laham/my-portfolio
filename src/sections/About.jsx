  ...
  return (
    <section className='sm:px-10 px-5 my-20' id='about'>
      <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full '>
        ...
        <div className='col-span-1 xl:row-span-3 '>
            <div className='w-full h-full border border-black-300 bg-black-200 rounded-lg sm:p-7 p-4 flex flex-col gap-5'>
                <img src='src/assets/grid2.png' alt="grid2" className='w-full sm:h-[276px] h-fit object-contain' />
                <div>
        ...
        <div className='xl:col-span-2 xl:row-span-3'>
            <div className='w-full h-full border border-black-300 bg-black-200 rounded-lg sm:p-7 p-4 flex flex-col gap-5'>
                <img src='src/assets/grid3.png' alt="grid3"  className='w-full sm:h-[266px] h-fit  object-contain'/>
                <div>
        ...
        <div className='xl:col-span-1 xl:row-span-2'>
            <div className='cursor-pointer flex justify-center items-center gap-2'>
                ...
                <img src='src/assets/grid4.png' alt="grid4" className='w-full md:h-[126px] sm:h-[276px] h-fit object-cover sm:object-top ' />
                <div className='space-y-2'>
                    ...
                    <div onClick={handleCopy} className='cursor-pointer flex justify-center items-center gap-2'>
                        <img src={hasCopied ? 'src/assets/tick.svg' : 'src/assets/copy.svg' } alt="" />
