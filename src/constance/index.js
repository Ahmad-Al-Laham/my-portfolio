...
export const myProjects = [
  {
    ...
    subdesc:
      "Built as a unique Software-as-a-Service app with Next.js 14, Tailwind CSS, Redux, Framer Motion and Convex, Podcastr is designed for optimal performance and scalability.",
